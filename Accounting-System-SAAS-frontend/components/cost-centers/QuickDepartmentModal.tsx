...
interface QuickDepartmentModalProps {
  open: boolean;
  onClose: () => void;
  companyId: string;
...
export function QuickDepartmentModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await api.post(`/companies/${companyId}/departments`, payload);
  ...
  return (
    <Modal open={open} onClose={onClose} title="Quick Create Department" size="md">
